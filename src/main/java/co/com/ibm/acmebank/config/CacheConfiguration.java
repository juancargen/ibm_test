package co.com.ibm.acmebank.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("stratangbackendgateway");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("stratangbackendgateway");
        ...
        config.getMapConfigs().put("ro.integ.stratalogica.microservice.domain.*", initializeDomainMapConfig(jHipsterProperties));
