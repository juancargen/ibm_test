 ...
 * @version 1.0.0
 */
@ApiModel(description = "Tipos de Producto")
@Entity
@Table(name = "ibm_tipo_producto")
...
public class TipoProducto implements Serializable {
    ...
    public TipoProducto description(String description) {
    ...
    public boolean equals(Object o) {
        ...
        TipoProducto mapType = (TipoProducto) o;
