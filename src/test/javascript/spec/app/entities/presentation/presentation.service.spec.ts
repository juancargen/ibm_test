    ...
    describe('Presentation Service', () => {
        ...
        describe('Service methods', () => {
            ...
            it('should create a Presentation', () => {
                service.create(new Presentation(null)).subscribe(received => {
            ...
            it('should update a Presentation', () => {
                service.update(new Presentation(123)).subscribe(received => {
            ...
            it('should return a Presentation', () => {
            ...
            it('should return a list of Presentation', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new Presentation(123)]);
            });
